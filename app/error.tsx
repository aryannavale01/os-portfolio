...
export default function Error({
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 text-white flex flex-col items-center justify-center gap-5 p-6 text-center select-none">
      ...
      <div className="flex gap-3">
        <button
          onClick={reset}
          className="px-4 py-2 rounded-xl bg-accent-600 hover:bg-accent-500 text-white text-xs font-semibold transition-colors"
        >
          Try again
        </button>
        <button
